...
public class UploadPDFDaemon extends AsyncTask<Void, String, String> {
    String tag = this.getClass().getSimpleName();
    String endpoint_picture = CheharaConst.ENDPOINT_PDF_UPLOAD;
    ...
    protected void onPreExecute() {
        ...
        pdialog.setMessage("Uploading PDF....");
        pdialog.show();
        super.onPreExecute();
    }

    public UploadPDFDaemon(Context context) {
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            if (!sourceFile.isFile()) {
                ...
                if (statuscode == 200) {
                    // TEXT RESUME HAS BEEN UPLOADED
                    message = "Text Resume has been uploaded";
                } else {
                    // TEXT RESUME UPLOAD FAILED. RETRY.
                    message = "Text Resume upload failed.Retry";
